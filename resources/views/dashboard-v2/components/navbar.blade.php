...
<nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
    ...
    <a class="navbar-brand me-1 me-sm-3" href="{{ route('dashboard.v2') }}">
        <div class="d-flex align-items-center"><img class="me-2"
                    src="https://i.imgur.com/VNInZj4.png" alt="" width="80" />
        </div>
    </a>
        ...
        <li class="nav-item">
            <div class="search-box" data-list='{"valueNames":["title"]}'>
                <form class="position-relative" data-bs-toggle="search" data-bs-display="static">
                    <input class="form-control search-input fuzzy-search" type="search" placeholder="Faça uma busca..."
                        aria-label="Search" />
                ...
                <div class="dropdown-menu border font-base start-0 mt-2 py-0 overflow-hidden w-100">
                    <div class="scrollbar list py-3" style="max-height: 24rem;">
                        ...
                        </h6><a class="dropdown-item fs-10 px-x1 py-1 hover-primary"
                        ...
                        <h6 class="dropdown-header fw-medium text-uppercase px-x1 fs-11 pt-0 pb-2">Suggested Filter
                        </h6><a class="dropdown-item px-x1 py-1 fs-9" href="app/e-commerce/customers.html">
