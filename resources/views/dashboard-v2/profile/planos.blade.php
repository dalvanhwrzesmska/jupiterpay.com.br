...
@section('content')
    <style>
        ...
        /* Dark mode para tela de planos */
        .dark .plano-card,
        [data-bs-theme="dark"] .plano-card,
        ...
        .dark .plano-card-destaque,
        [data-bs-theme="dark"] .plano-card-destaque,
        body.dark .plano-card-destaque {
            border-color: #3c8ce7 !important;
        }

        .dark .plano-titulo,
        [data-bs-theme="dark"] .plano-titulo,
        body.dark .plano-titulo {
            color: #fff !important;
        }

        .dark .plano-faixa,
        [data-bs-theme="dark"] .plano-faixa,
        body.dark .plano-faixa {
            color: #3c8ce7 !important;
        }

        .dark .plano-preco,
        [data-bs-theme="dark"] .plano-preco,
        body.dark .plano-preco {
            color: #10b981 !important;
        }

        .dark .plano-taxa,
        [data-bs-theme="dark"] .plano-taxa,
        body.dark .plano-taxa {
            color: #6ee7b7 !important;
        }

        .dark .plano-beneficios li,
        [data-bs-theme="dark"] .plano-beneficios li,
        body.dark .plano-beneficios li {
            color: #bfc8e2 !important;
        }

        .dark .plano-btn,
        [data-bs-theme="dark"] .plano-btn,
        body.dark .plano-btn {
            background: #3c8ce7 !important;
            color: #fff !important;
        }

        .dark .plano-btn:hover,
        [data-bs-theme="dark"] .plano-btn:hover,
        body.dark .plano-btn:hover {
            background: #10b981 !important;
            color: #fff !important;
        }

        .dark .plano-btn[disabled],
        .dark .plano-btn.disabled,
        [data-bs-theme="dark"] .plano-btn[disabled],
        [data-bs-theme="dark"] .plano-btn.disabled,
        body.dark .plano-btn[disabled],
        body.dark .plano-btn.disabled {
        ...
        .dark h1.fw-bold.text-dark,
        [data-bs-theme="dark"] h1.fw-bold.text-dark,
        body.dark h1.fw-bold.text-dark {
            color: #fff !important;
        }
    </style>
        ...
        <div class="planos-cards-row">
            <div class="plano-card">
                @if($activePlanSlug === 'basico')
                    <span style="position:absolute;top:-18px;left:50%;transform:translateX(-50%);"
                        class="badge bg-success px-4 py-2 fs-6">Ativo</span>
                @endif
                ...
                <form method="POST" action="{{ route('planos.subscribe', 1) }}">
                    @csrf
                    <button type="submit" class="plano-btn @if($activePlanSlug === 'basico') disabled @endif"
                        @if($activePlanSlug === 'basico') disabled @endif>Assinar Plano Básico</button>
                </form>
            </div>
            <div class="plano-card plano-card-destaque">
                ...
                <form method="POST" action="{{ route('planos.subscribe', 2) }}">
                    @csrf
                    <button type="submit" class="plano-btn @if($activePlanSlug === 'pro') disabled @endif"
                        @if($activePlanSlug === 'pro') disabled @endif>Assinar Plano Pro</button>
                </form>
            </div>
            <div class="plano-card">
                ...
                <form method="POST" action="{{ route('planos.subscribe', 3) }}">
                    @csrf
                    <button type="submit" class="plano-btn @if($activePlanSlug === 'premium') disabled @endif"
                        @if($activePlanSlug === 'premium') disabled @endif>Assinar Plano Premium</button>
                </form>
            </div>
        </div>
