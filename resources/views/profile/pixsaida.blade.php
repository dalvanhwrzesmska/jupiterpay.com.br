                ...
                <div class="row g-4">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="card card-raised highlight-card h-100">
                            <div class="card-body px-4 py-3 d-flex align-items-center justify-content-between">
                                <div>
                                    <div class="display-6 fw-bold text-info">R$ {{ number_format($allTransactions->sum('cash_out_liquido'), '2',',','.') }}</div>
                            ...
                            <div class="card-body px-4 py-3 d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    if ($totalTransacoesFiltradas > 0) {
                                        $somaSaqueLiquido = $allTransactions->sum('amount');
                                    ...
                                    <div class="col-auto">
                                        <nav aria-label="Navegação da paginação">
                                            <ul class="pagination pagination-sm mb-0">
                                                @if($page > 1)
                                                <li class="page-item">
                                                    <a class="page-link" href="{{ route('profile.relatorio.pixsaida') }}?page={{ $page - 1 }}&periodo={{ $periodo ?? '' }}&buscar={{ $buscar ?? '' }}">
                                                ...
                                                @if($start > 1)
                                                <li class="page-item">
                                                    <a class="page-link" href="{{ route('profile.relatorio.pixsaida') }}?page=1&periodo={{ $periodo ?? '' }}&buscar={{ $buscar ?? '' }}">1</a>
                                                </li>
                                                @if($start > 2)
                                                ...
                                                <li class="page-item {{ $i == $page ? 'active' : '' }}">
                                                    <a class="page-link" href="{{ route('profile.relatorio.pixsaida') }}?page={{ $i }}&periodo={{ $periodo ?? '' }}&buscar={{ $buscar ?? '' }}">{{ $i }}</a>
                                                </li>
                                                @endfor
                                                ...
                                                @endif
                                                <li class="page-item">
                                                    <a class="page-link" href="{{ route('profile.relatorio.pixsaida') }}?page={{ $totalPages }}&periodo={{ $periodo ?? '' }}&buscar={{ $buscar ?? '' }}">{{ $totalPages }}</a>
                                                </li>
                                                @endif
