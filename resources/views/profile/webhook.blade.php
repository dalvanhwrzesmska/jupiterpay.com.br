<x-app-layout :route="'Webhook'">
  <style>
    ...
    @media (max-width: 900px) {
      ...
      .webhook-json-box { padding: 1.1rem 1.1rem; }
    }
  </style>
        ...
        <div class="webhook-modern-example-col">
          <div class="webhook-modern-card p-4" style="line-height:21px">
            ...
            <div class="webhook-json-box">
              <button class="webhook-copy-btn" onclick="copyWebhookJson()"><i class="fa fa-copy"></i> Copiar</button>
              <pre id="webhook-json-recebido" style="margin-bottom:0;background:transparent;border:none;box-shadow:none;padding:0;">{
  "nome": "João Silva",
  "cpf": "123.456.789-00",
  ...
  "status": "pago"
            ...
            <div class="mt-3 text-muted" style="font-size:0.98rem;">
              <span class="badge bg-info text-dark">POST</span> O webhook receberá uma requisição com os dados acima.
            </div>
          </div>
        </div>
      </div>
